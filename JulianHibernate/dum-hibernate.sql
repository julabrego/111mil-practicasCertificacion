...
CREATE TABLE `DetalleOrden` (
  ...
  KEY `DetalleOrden_Orden_idOrder_fk` (`Order_idOrder`),
  CONSTRAINT `DetalleOrden_Notebook_fk` FOREIGN KEY (`Notebook_idNotebook`) REFERENCES `Notebook` (`idNotebook`),
  CONSTRAINT `DetalleOrden_Orden_idOrder_fk` FOREIGN KEY (`Order_idOrder`) REFERENCES `Orden` (`idOrder`)
...
CREATE TABLE `Orden` (
  ...
  PRIMARY KEY (`idOrder`),
  UNIQUE KEY `Order_idOrder_uindex` (`idOrder`),
...
-- Dump completed on 2018-11-02 19:37:11
